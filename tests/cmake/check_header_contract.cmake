...
function(expect_internal_frontier_failure name header)
    set(internal_source "${output_dir}/${name}.cpp")
    file(WRITE "${internal_source}"
    ...
    set(expected_diagnostic
        "include gint IO internals through <gint/io.hpp> or <gint/gint.hpp> after <gint/core.hpp>"
    )
    string(FIND "${output}" "${expected_diagnostic}" diagnostic_position)
    if(diagnostic_position EQUAL -1)
        message(FATAL_ERROR
...
expect_internal_frontier_failure(core_then_string_stream string_stream.hpp)
expect_internal_frontier_failure(core_then_fmt fmt.hpp)
